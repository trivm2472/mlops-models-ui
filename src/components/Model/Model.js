    ...
    <div style={{ marginLeft: 90, display: "flex", flexDirection: "row" }}>
      <div style={{ flexBasis: "80%" }}>
        ...
        >
          ...
          <h1 style={{ fontWeight: "600", fontFamily: "Roboto, sans-serif", marginLeft: 20 }}>
            {data ? data.modelName : ""}
          </h1>
        </span>
        <h2 style={{ marginBottom: 5 }}>Version: {data ? data.version : ""}</h2>
        <div
          className="header"
          style={{
            display: "flex",
        ...
        >
          ...
          />
          <div style={{ fontSize: 24, fontWeight: 700, color: '#212A3E' }}>Advanced result:</div>
        </div>
        ...
        <h2 style={{ marginTop: 30 }}>Last update: {data ? data.date : ""}</h2>
      </div>
